...
<body>
    ...
    <div class="disc">
        ...
        <ul>
            ...
            <li>Mobile Accessibility: Job hunting on the go? JobDen is mobile-friendly.</li>
        </ul>

        <h2>Join Our Thriving Community</h2>
        <p>JobDen isn't just a job portal; it's a community of like-minded individuals committed to professional
            growth. Share insights, seek advice, and celebrate successes with fellow members.</p>

        <p>Ready to embark on your career journey? <a href="signup.php">Create your JobDen account</a> today and
            unlock a
